...
const routes = [
    ...
    { path: 'hello', component: _hello_hello_component__WEBPACK_IMPORTED_MODULE_2__["HelloComponent"] },
    { path: 'project-detail/:id', component: _project_detail_project_detail_component__WEBPACK_IMPORTED_MODULE_1__["ProjectDetailComponent"] },
